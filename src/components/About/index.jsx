...
function About() {
    return (
      <div className="about-container">
          ...
          When I’m not coordinating projects and promoting efficiency, I enjoy visiting beautiful islands like Punta Cana, Bora Bora, trying out new recipes, and training on Gracie Jiu-Jitsu for self delf.<br></br><br></br>
          Project manager with leadership experience and technical know-how. Previous experience includes project manager for a general contractor company in Winter Garden FL,  ANC Roofing, where I oversaw the execution of weekly re-roofs and managed a team of seven-five crew members. Additionally, I completed the Web Developer Certificate at the University of Central Florida, where I developed knowledge and experience in Scrum and Agile frameworks as well as Software and Project Management lifecycles, among others. Planned, developed, and successfully executed projects, deployed by Heroku, and have led teams in previous roles of varying size to meet company goals. Excited to combine technical training and management experience to continue leading teams to success..</p><br></br>
          </div>
      </div>
      )
  }
